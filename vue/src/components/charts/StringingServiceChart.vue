<template>
  <div class="glass-card chart-card stringing-service-card">
    <div class="chart-header">
      <div class="header-left">
        <span class="chart-title">🎾 穿线服务统计</span>
        <span class="chart-subtitle">服务状态分布与数量占比</span>
      </div>
      <el-link type="primary" :underline="false" class="view-all" @click="navigateTo('/equipment/stringing')">
        查看详情
      </el-link>
    </div>
      ...
      <div class="stats-panel">
        <div class="stat-item" v-for="(item, index) in statsData" :key="index">
          ...
          <div class="stat-info">
            ...
            <div class="stat-value">{{ item.value }} 单</div>
          </div>
...
// 颜色方案（与穿线状态语义对应：等待-黄、进行中-蓝、已完成-绿、已取消-灰）
const colorScheme = [
  { start: '#FCD34D', end: '#F59E0B' },   // 等待穿线 - 橙黄
  { start: '#60A5FA', end: '#2563EB' },   // 正在穿线 - 蓝色
  { start: '#34D399', end: '#10B981' },   // 已完成 - 绿色
  { start: '#94A3B8', end: '#64748B' }    // 已取消 - 灰色
]
      ...
      formatter: (params) => {
        return `
          ...
          <div style="display: flex; align-items: center; justify-content: space-between; gap: 24px;">
            <span>服务单数:</span>
            <span style="font-weight: 600; color: ${params.color};">${params.value} 单</span>
          </div>
