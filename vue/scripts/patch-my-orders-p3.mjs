...
const p = new URL('../src/views/user/MyOrders.vue', import.meta.url)
const content = `<template>
  <div class="my-orders-page">
    ...
    <el-alert
      v-if="configLoaded && !autoCancelEnabled"
      type="info"
      :closable="false"
      show-icon
      class="feature-hint"
      title="支付超时自动取消功能未开启，订单将不会自动取消"
    />
