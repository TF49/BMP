<template>
  <PresidentLayout :showTabBar="true">
    <view class="finance-stats-page">
      ...
      <view class="top-nav">
        <view class="nav-left">
          <uni-icons type="fire-filled" size="24" color="#ea580c" class="logo-icon"></uni-icons>
          <text class="logo-text">Kinetic Logic 羽 擎</text>
        </view>
        <view class="nav-right">
          <view class="icon-btn hover-scale">
            <uni-icons type="notification" size="24" color="#71717a"></uni-icons>
          </view>
          <view class="avatar-wrap">
            <image class="avatar" src="https://lh3.googleusercontent.com/aida-public/AB6AXuA0E6CiVAW0OyYr-ZMs1K3X2pejNccRM5UfZZxJEl1EADB0SqHp1hgcUad-0qWsghPSJqXN-LegPXmmD3UrUNDRuU5_5NQyeCJ9ky0TNj0kKmPQg8Zi1tUmAiwako7NhrxfLqil0LJWYEvPnofI7UUgLstgv3QHHjeK8cBE5ZrI5mqvBNnxlDxSHYd1tEyQmTe8xuIxgnRY86J2RAnRmqyUdTHTL0e5uuxweWencEScg22zQ7Ko2I9nYBv0qrk3kIQdQA3Uey9G5I3G" mode="aspectFill"></image>
          </view>
        </view>
      </view>
