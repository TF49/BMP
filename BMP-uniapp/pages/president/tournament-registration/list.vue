<template>
  <PresidentLayout :showTabBar="false">
    <view class="page">
      ...
      <view class="nav-header">
        <view class="nav-row">
          <view class="nav-left" @click="goBack">
            ...
            <text class="nav-title">赛事报名管理</text>
          </view>
        </view>
      </view>
      ...
      <view class="content">
        <view class="card">
          <text class="title">报名列表（占位）</text>
          <text class="desc">用于会长端查看/审核赛事报名、导出名单等。当前为占位页，避免路由跳转失败。</text>
          <view class="actions">
            <button class="ghost-btn" @click="openDetailDemo">查看报名详情（示例）</button>
...
function openDetailDemo() {
  uni.navigateTo({
    url: `${PRESIDENT_PAGES.TOURNAMENT_REGISTRATION_DETAIL}?id=demo`
  })
}
</script>
