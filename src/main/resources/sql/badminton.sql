...
INSERT INTO `biz_finance` VALUES (45, 'FN20260207003', 'RECHARGE', 8, 1, 200.00, 'ALIPAY', NULL, 'admin', 1, '会员充值：演示用户A - ', 'AUTO', 0, NULL, NULL, '2026-02-07 16:15:29', 0);
INSERT INTO `biz_finance` VALUES (46, 'FN20260207004', 'RECHARGE', 9, 1, 200.00, 'ALIPAY', NULL, 'admin', 1, '会员充值：演示用户A - ', 'AUTO', 0, NULL, NULL, '2026-02-07 16:15:42', 0);
INSERT INTO `biz_finance` VALUES (47, 'FN20260207005', 'RECHARGE', 10, 1, 200.00, 'ALIPAY', NULL, 'admin', 1, '会员充值：演示用户A - ', 'AUTO', 0, NULL, NULL, '2026-02-07 16:15:44', 0);
INSERT INTO `biz_finance` VALUES (48, 'FN20260207006', 'RECHARGE', 11, 1, 200.00, 'ALIPAY', NULL, 'admin', 1, '会员充值：演示用户A - ', 'AUTO', 0, NULL, NULL, '2026-02-07 16:15:46', 0);
INSERT INTO `biz_finance` VALUES (49, 'FN20260207007', 'RECHARGE', 12, 1, 200.00, 'ALIPAY', NULL, 'admin', 1, '会员充值：演示用户A - ', 'AUTO', 0, NULL, NULL, '2026-02-07 16:15:48', 0);
INSERT INTO `biz_finance` VALUES (50, 'FN20260207008', 'RECHARGE', 13, 1, 200.00, 'ALIPAY', NULL, 'admin', 1, '会员充值：演示用户A - ', 'AUTO', 0, NULL, NULL, '2026-02-07 16:17:41', 0);
...
INSERT INTO `biz_finance` VALUES (52, 'FN20260207010', 'RECHARGE', 15, 1, 200.00, 'ALIPAY', NULL, 'admin', 1, '会员充值：演示用户A - ', 'AUTO', 0, NULL, NULL, '2026-02-07 16:32:24', 0);
INSERT INTO `biz_finance` VALUES (53, 'FN20260207011', 'RECHARGE', 16, 1, 300.00, 'ALIPAY', NULL, 'admin', 1, '会员充值：演示用户A - ', 'AUTO', 0, NULL, NULL, '2026-02-07 16:32:28', 0);
...
INSERT INTO `biz_finance` VALUES (59, 'FN20260209001', 'RECHARGE', 22, 1, 400.00, 'CASH', NULL, 'admin', 1, '会员充值：演示用户A', 'AUTO', 0, NULL, NULL, '2026-02-09 13:28:47', 0);
INSERT INTO `biz_finance` VALUES (60, 'FN20260209002', 'RECHARGE', 23, 1, 300.00, 'CASH', NULL, 'admin', 1, '会员充值：演示用户A - ', 'AUTO', 0, NULL, NULL, '2026-02-09 13:29:06', 0);
...
INSERT INTO `biz_finance` VALUES (68, 'FN20260209010', 'RECHARGE', 26, 1, 15.00, 'ALIPAY', NULL, 'admin', 1, '会员充值：演示用户A', 'AUTO', 0, NULL, NULL, '2026-02-09 23:14:55', 0);
...
INSERT INTO `biz_finance` VALUES (103, 'FN20260217001', 'RECHARGE', 31, 1, 1000.00, 'CASH', NULL, 'admin', 1, '会员充值：演示用户A - ', 'AUTO', 0, NULL, NULL, '2026-02-17 14:04:11', 0);
...
INSERT INTO `biz_finance` VALUES (110, 'FN20260217008', 'RECHARGE', 32, 1, 1000.00, 'ALIPAY', NULL, 'admin', 1, '会员充值：演示用户A - ', 'AUTO', 0, NULL, NULL, '2026-02-17 18:10:28', 0);
...
INSERT INTO `biz_finance` VALUES (116, 'FN20260218006', 'RECHARGE', 33, 1, 5000.00, 'ALIPAY', NULL, 'admin', 1, '会员充值：演示用户A', 'AUTO', 0, NULL, NULL, '2026-02-18 14:53:18', 0);
INSERT INTO `biz_finance` VALUES (117, 'FN20260218007', 'RECHARGE', 34, 1, 300.00, 'WECHAT', NULL, 'admin', 1, '会员充值：演示用户A - ', 'AUTO', 0, NULL, NULL, '2026-02-18 14:54:02', 0);
INSERT INTO `biz_finance` VALUES (118, 'FN20260221001', 'RECHARGE', 35, 1, 2000.00, 'ALIPAY', NULL, 'admin', 1, '会员充值：演示用户A', 'AUTO', NULL, NULL, NULL, '2026-02-21 12:04:58', 0);
INSERT INTO `biz_finance` VALUES (119, 'FN20260222001', 'RECHARGE', 36, 1, 1000.00, 'ALIPAY', NULL, 'admin', 1, '会员充值：演示用户A - ', 'AUTO', NULL, NULL, NULL, '2026-02-22 15:31:23', 0);
INSERT INTO `biz_finance` VALUES (120, 'FN20260222002', 'RECHARGE', 37, 1, 200.00, 'ALIPAY', NULL, 'admin', 1, '会员充值：佘建鹏 - ', 'AUTO', NULL, NULL, NULL, '2026-02-22 15:36:58', 0);
INSERT INTO `biz_finance` VALUES (121, 'FN20260222003', 'RECHARGE', 38, 1, 1000.00, 'BALANCE', NULL, '佘建鹏', 14, '会员充值：佘建鹏', 'AUTO', NULL, NULL, NULL, '2026-02-22 15:39:00', 0);
...
CREATE TABLE `biz_finance_reconciliation`  (
  ...
  `business_amount` decimal(12, 2) NULL DEFAULT 0.00 COMMENT '业务总金额',
  `finance_amount` decimal(12, 2) NULL DEFAULT 0.00 COMMENT '财务总金额',
  `count_diff` int NULL DEFAULT 0 COMMENT '数量差异（业务-财务）',
  `amount_diff` decimal(12, 2) NULL DEFAULT 0.00 COMMENT '金额差异（业务-财务）',
...
CREATE TABLE `biz_member_consume_record`  (
  ...
  `amount` decimal(12, 2) NOT NULL COMMENT '金额（正数-消费，负数-退款/冲正）',
  ...
  `payment_status` tinyint(1) NULL DEFAULT 0 COMMENT '支付状态（0-未支付，1-已支付，2-已退款）',
  `before_balance` decimal(12, 2) NULL DEFAULT NULL COMMENT '扣款前余额（仅余额相关时记录）',
  `venue_id` bigint NULL DEFAULT NULL COMMENT '所属场馆ID（业务所属场馆，便于场馆级查询）',
  `after_balance` decimal(12, 2) NULL DEFAULT NULL COMMENT '扣款后余额（仅余额相关时记录）',
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '备注',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_member_id`(`member_id` ASC) USING BTREE,
...
CREATE TABLE `biz_tournament`  (
  ...
  `event_type` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '比赛项目（MS-男单，WS-女单，MD-男双，WD-女双，XD-混双）',
  `format_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '赛制类型（单败淘汰制、循环赛制、双败淘汰制、瑞士轮制）',
...
-- ----------------------------
INSERT INTO `biz_tournament` (`id`, `tournament_name`, `tournament_type`, `event_type`, `format_type`, `venue_id`, `max_participants`, `current_participants`, `registration_start`, `registration_end`, `tournament_start`, `tournament_end`, `entry_fee`, `prize_info`, `description`, `status`, `create_time`, `update_time`, `del_flag`) VALUES (1, '2025年春季羽毛球公开赛', 'DOUBLE', 'MD', '单败淘汰制', 1, 32, 24, '2025-01-01 00:00:00', '2025-02-15 23:59:59', '2025-02-20 09:00:00', '2025-02-23 18:00:00', 100.00, '冠军：5000元+奖杯，亚军：3000元+奖牌，季军：2000元+奖牌', '春季大型羽毛球赛事，欢迎各水平选手参加', 3, '2024-12-01 10:00:00', '2026-02-17 13:01:47', 0);
INSERT INTO `biz_tournament` (`id`, `tournament_name`, `tournament_type`, `event_type`, `format_type`, `venue_id`, `max_participants`, `current_participants`, `registration_start`, `registration_end`, `tournament_start`, `tournament_end`, `entry_fee`, `prize_info`, `description`, `status`, `create_time`, `update_time`, `del_flag`) VALUES (2, '2025年夏季羽毛球挑战赛', 'SINGLE', 'MS', '单败淘汰制', 2, 64, 48, '2025-03-01 00:00:00', '2025-04-15 23:59:59', '2025-04-20 09:00:00', '2025-04-22 18:00:00', 80.00, '冠军：3000元+奖杯，亚军：2000元+奖牌，季军：1000元+奖牌', '夏季单打挑战赛', 3, '2025-01-01 10:00:00', '2026-02-17 13:01:47', 0);
INSERT INTO `biz_tournament` (`id`, `tournament_name`, `tournament_type`, `event_type`, `format_type`, `venue_id`, `max_participants`, `current_participants`, `registration_start`, `registration_end`, `tournament_start`, `tournament_end`, `entry_fee`, `prize_info`, `description`, `status`, `create_time`, `update_time`, `del_flag`) VALUES (3, '2025年混双友谊赛', 'MIXED', 'XD', '单败淘汰制', 3, 32, 28, '2025-02-01 00:00:00', '2025-03-10 23:59:59', '2025-03-15 09:00:00', '2025-03-17 18:00:00', 120.00, '冠军：4000元+奖杯，亚军：2500元+奖牌', '混双专项赛事', 3, '2024-12-15 10:00:00', '2026-02-17 13:01:47', 0);
INSERT INTO `biz_tournament` (`id`, `tournament_name`, `tournament_type`, `event_type`, `format_type`, `venue_id`, `max_participants`, `current_participants`, `registration_start`, `registration_end`, `tournament_start`, `tournament_end`, `entry_fee`, `prize_info`, `description`, `status`, `create_time`, `update_time`, `del_flag`) VALUES (4, '2025年青少年锦标赛', 'SINGLE', 'MS', '单败淘汰制', 4, 48, 36, '2025-04-01 00:00:00', '2025-05-15 23:59:59', '2025-05-20 09:00:00', '2025-05-22 18:00:00', 60.00, '冠军：2000元+奖杯，亚军：1500元+奖牌，季军：1000元+奖牌', '青少年专项赛事', 3, '2025-02-01 10:00:00', '2026-02-17 13:01:47', 0);
INSERT INTO `biz_tournament` (`id`, `tournament_name`, `tournament_type`, `event_type`, `format_type`, `venue_id`, `max_participants`, `current_participants`, `registration_start`, `registration_end`, `tournament_start`, `tournament_end`, `entry_fee`, `prize_info`, `description`, `status`, `create_time`, `update_time`, `del_flag`) VALUES (5, '2024年冬季羽毛球联赛', 'TEAM', NULL, '单败淘汰制', 5, 16, 16, '2024-10-01 00:00:00', '2024-11-15 23:59:59', '2024-11-20 09:00:00', '2024-11-25 18:00:00', 500.00, '冠军：10000元+奖杯，亚军：6000元+奖牌', '团队联赛，已结束', 4, '2024-09-01 10:00:00', NULL, 0);
INSERT INTO `biz_tournament` (`id`, `tournament_name`, `tournament_type`, `event_type`, `format_type`, `venue_id`, `max_participants`, `current_participants`, `registration_start`, `registration_end`, `tournament_start`, `tournament_end`, `entry_fee`, `prize_info`, `description`, `status`, `create_time`, `update_time`, `del_flag`) VALUES (6, '2025年满员测试赛事', 'SINGLE', 'MS', '单败淘汰制', 1, 10, 10, '2025-05-01 00:00:00', '2025-06-30 23:59:59', '2025-07-01 09:00:00', '2025-07-03 18:00:00', 50.00, '测试赛事奖品', '用于测试名额检查功能的满员赛事', 3, '2025-01-20 10:00:00', '2026-02-17 13:01:47', 0);
INSERT INTO `biz_tournament` (`id`, `tournament_name`, `tournament_type`, `event_type`, `format_type`, `venue_id`, `max_participants`, `current_participants`, `registration_start`, `registration_end`, `tournament_start`, `tournament_end`, `entry_fee`, `prize_info`, `description`, `status`, `create_time`, `update_time`, `del_flag`) VALUES (7, '2025年待支付测试赛事', 'DOUBLE', 'MD', '单败淘汰制', 1, 32, 2, '2025-05-01 00:00:00', '2025-06-30 23:59:59', '2025-07-01 09:00:00', '2025-07-03 18:00:00', 100.00, '测试赛事奖品', '用于测试支付功能的赛事', 3, '2025-01-20 10:00:00', '2026-02-18 14:00:58', 0);
INSERT INTO `biz_tournament` (`id`, `tournament_name`, `tournament_type`, `event_type`, `format_type`, `venue_id`, `max_participants`, `current_participants`, `registration_start`, `registration_end`, `tournament_start`, `tournament_end`, `entry_fee`, `prize_info`, `description`, `status`, `create_time`, `update_time`, `del_flag`) VALUES (8, '2025年人数联动测试赛事', 'SINGLE', 'MS', '单败淘汰制', 2, 20, 3, '2025-05-01 00:00:00', '2025-06-30 23:59:59', '2025-07-01 09:00:00', '2025-07-03 18:00:00', 60.00, '测试赛事奖品', '用于测试当前参赛人数联动功能的赛事', 3, '2025-01-20 10:00:00', '2026-02-17 13:01:47', 0);
INSERT INTO `biz_tournament` (`id`, `tournament_name`, `tournament_type`, `event_type`, `format_type`, `venue_id`, `max_participants`, `current_participants`, `registration_start`, `registration_end`, `tournament_start`, `tournament_end`, `entry_fee`, `prize_info`, `description`, `status`, `create_time`, `update_time`, `del_flag`) VALUES (9, '2025年空赛事测试', 'SINGLE', 'MS', '单败淘汰制', 3, 15, 0, '2025-05-01 00:00:00', '2025-06-30 23:59:59', '2025-07-01 09:00:00', '2025-07-03 18:00:00', 50.00, '测试赛事奖品', '用于测试从0开始的人数联动功能（创建第一个报名后人数应变为1，取消后应变为0）', 3, '2025-01-20 10:00:00', '2026-02-17 13:01:47', 0);
INSERT INTO `biz_tournament` (`id`, `tournament_name`, `tournament_type`, `event_type`, `format_type`, `venue_id`, `max_participants`, `current_participants`, `registration_start`, `registration_end`, `tournament_start`, `tournament_end`, `entry_fee`, `prize_info`, `description`, `status`, `create_time`, `update_time`, `del_flag`) VALUES (10, '2026年新春羽毛球比赛', NULL, NULL, '单败淘汰制', 6, 16, 0, '2026-02-17 13:23:00', '2026-02-17 13:23:50', '2026-02-17 13:24:00', '2026-02-17 13:24:50', 10.00, NULL, NULL, 3, '2026-02-17 13:24:23', '2026-02-17 13:25:21', 1);
INSERT INTO `biz_tournament` (`id`, `tournament_name`, `tournament_type`, `event_type`, `format_type`, `venue_id`, `max_participants`, `current_participants`, `registration_start`, `registration_end`, `tournament_start`, `tournament_end`, `entry_fee`, `prize_info`, `description`, `status`, `create_time`, `update_time`, `del_flag`) VALUES (11, '2026新春羽毛球比赛', 'DOUBLE', 'MD', '单败淘汰制', 6, 16, 0, '2026-02-17 13:27:00', '2026-02-17 13:28:00', '2026-02-17 13:29:00', '2026-02-17 13:30:00', 10.00, NULL, NULL, 3, '2026-02-17 13:27:54', '2026-02-17 13:33:11', 0);
INSERT INTO `biz_tournament` (`id`, `tournament_name`, `tournament_type`, `event_type`, `format_type`, `venue_id`, `max_participants`, `current_participants`, `registration_start`, `registration_end`, `tournament_start`, `tournament_end`, `entry_fee`, `prize_info`, `description`, `status`, `create_time`, `update_time`, `del_flag`) VALUES (12, '2026新春羽毛球比赛', 'SINGLE', 'MS', '单败淘汰制', 6, 2, 0, '2026-02-18 00:00:00', '2026-02-18 22:00:00', '2026-02-19 00:00:00', '2026-02-20 00:00:00', 0.00, NULL, NULL, 0, '2026-02-18 13:46:45', '2026-02-18 14:09:05', 0);
...
CREATE TABLE `biz_tournament_registration`  (
  ...
  `registrant_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '报名人姓名快照',
  `registrant_phone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '报名人手机号快照',
  `registrant_id_card` varchar(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '报名人身份证号快照',
  `event_type_snapshot` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '比赛项目编码快照',
  `event_type_name_snapshot` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '比赛项目名称快照',
  `partner_name_snapshot` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '搭档姓名快照',
  `partner_phone_snapshot` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '搭档手机号快照',
...
-- ----------------------------
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (1, 'TR20250101001', 1, 1, 2, 100.00, 'ALIPAY', 1, 3, NULL, NULL, '2025-01-05 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (2, 'TR20250101002', 1, 3, 4, 100.00, 'WECHAT', 1, 3, NULL, NULL, '2025-01-06 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (3, 'TR20250101003', 1, 5, 6, 100.00, 'BALANCE', 1, 3, NULL, NULL, '2025-01-07 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (4, 'TR20250101004', 1, 7, 8, 100.00, 'ALIPAY', 1, 3, NULL, NULL, '2025-01-08 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (5, 'TR20250101005', 1, 9, 10, 100.00, 'WECHAT', 1, 3, NULL, NULL, '2025-01-09 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (6, 'TR20250301001', 2, 11, NULL, 80.00, 'BALANCE', 1, 3, NULL, NULL, '2025-03-05 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (7, 'TR20250301002', 2, 12, NULL, 80.00, 'ALIPAY', 1, 3, NULL, NULL, '2025-03-06 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (8, 'TR20250301003', 2, 13, NULL, 80.00, 'WECHAT', 1, 3, NULL, NULL, '2025-03-07 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (9, 'TR20250201001', 3, 14, 15, 120.00, 'ALIPAY', 1, 3, NULL, NULL, '2025-02-05 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (10, 'TR20250201002', 3, 16, 17, 120.00, 'WECHAT', 1, 3, NULL, NULL, '2025-02-06 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (11, 'TR20250201003', 3, 18, 19, 120.00, 'BALANCE', 1, 3, NULL, NULL, '2025-02-07 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (12, 'TR20250401001', 4, 20, NULL, 60.00, 'ALIPAY', 1, 3, NULL, NULL, '2025-04-05 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (13, 'TR20250401002', 4, 21, NULL, 60.00, 'WECHAT', 1, 3, NULL, NULL, '2025-04-06 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (14, 'TR20250401003', 4, 22, NULL, 60.00, 'BALANCE', 1, 3, NULL, NULL, '2025-04-07 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (15, 'TR20241001001', 5, 23, NULL, 500.00, 'ALIPAY', 1, 3, NULL, NULL, '2024-10-05 10:00:00', NULL, 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (16, 'TR20241001002', 5, 24, NULL, 500.00, 'WECHAT', 1, 3, NULL, NULL, '2024-10-06 10:00:00', NULL, 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (17, 'TR20250601001', 6, 1, NULL, 50.00, 'ALIPAY', 1, 3, NULL, NULL, '2025-06-01 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (18, 'TR20250601002', 6, 2, NULL, 50.00, 'WECHAT', 1, 3, NULL, NULL, '2025-06-01 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (19, 'TR20250601003', 6, 3, NULL, 50.00, 'BALANCE', 1, 3, NULL, NULL, '2025-06-01 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (20, 'TR20250601004', 6, 4, NULL, 50.00, 'ALIPAY', 1, 3, NULL, NULL, '2025-06-01 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (21, 'TR20250601005', 6, 5, NULL, 50.00, 'WECHAT', 1, 3, NULL, NULL, '2025-06-01 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (22, 'TR20250601006', 6, 6, NULL, 50.00, 'BALANCE', 1, 3, NULL, NULL, '2025-06-01 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (23, 'TR20250601007', 6, 7, NULL, 50.00, 'ALIPAY', 1, 3, NULL, NULL, '2025-06-01 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (24, 'TR20250601008', 6, 8, NULL, 50.00, 'WECHAT', 1, 3, NULL, NULL, '2025-06-01 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (25, 'TR20250601009', 6, 9, NULL, 50.00, 'BALANCE', 1, 3, NULL, NULL, '2025-06-01 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (26, 'TR20250601010', 6, 10, NULL, 50.00, 'ALIPAY', 1, 3, NULL, NULL, '2025-06-01 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (27, 'TR20250602001', 7, 11, 12, 100.00, NULL, 0, 0, NULL, NULL, '2025-06-02 10:00:00', '2026-02-18 14:00:57', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (28, 'TR20250602002', 7, 13, 14, 100.00, NULL, 0, 0, NULL, NULL, '2025-06-02 10:00:00', '2026-02-18 14:00:56', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (29, 'TR20250602003', 7, 15, 16, 100.00, 'BALANCE', 1, 3, NULL, NULL, '2025-06-02 10:00:00', '2026-02-18 14:09:25', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (30, 'TR20250602004', 7, 17, 18, 100.00, NULL, 0, 0, NULL, NULL, '2025-06-02 10:00:00', '2026-02-18 14:00:58', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (31, 'TR20250602005', 7, 19, 20, 100.00, 'CASH', 1, 3, NULL, NULL, '2025-06-02 10:00:00', '2026-02-18 14:10:25', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (32, 'TR20250603001', 8, 21, NULL, 60.00, 'ALIPAY', 1, 3, NULL, NULL, '2025-06-03 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (33, 'TR20250603002', 8, 22, NULL, 60.00, 'WECHAT', 1, 3, NULL, NULL, '2025-06-03 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (34, 'TR20250603003', 8, 23, NULL, 60.00, 'BALANCE', 1, 3, NULL, NULL, '2025-06-03 10:00:00', '2026-02-18 12:54:09', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (35, 'TR20260218001', 12, 45, NULL, 0.00, 'BALANCE', 1, 0, NULL, NULL, '2026-02-18 13:55:58', '2026-02-18 14:00:51', 0);
INSERT INTO `biz_tournament_registration` (`id`, `registration_no`, `tournament_id`, `member_id`, `partner_id`, `entry_fee`, `payment_method`, `payment_status`, `status`, `match_result`, `remark`, `create_time`, `update_time`, `del_flag`) VALUES (36, 'TR20260218002', 12, 1, NULL, 0.00, 'BALANCE', 1, 0, NULL, NULL, '2026-02-18 13:59:12', '2026-02-18 14:00:52', 0);
...
INSERT INTO `sys_coach` VALUES (13, '演示用户A', 1, NULL, NULL, NULL, NULL, 200.00, 5.00, 50, 1, '/api/uploads/avatars/52083bd8b9464ad4b27514480041b298.jpg', 6, NULL, '2026-02-15 10:14:28', '2026-02-15 10:16:41', 1);
INSERT INTO `sys_coach` VALUES (14, '演示用户A', 1, NULL, NULL, NULL, NULL, 200.00, 5.00, 50, 1, '/api/uploads/avatars/52083bd8b9464ad4b27514480041b298.jpg', 6, NULL, '2026-02-15 10:16:50', '2026-02-15 10:16:50', 0);
...
CREATE TABLE `sys_member`  (
  ...
  `total_recharge` decimal(12, 2) NULL DEFAULT 0.00,
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `del_flag` tinyint(1) NULL DEFAULT 0 COMMENT '逻辑删除标记（0-正常，1-删除）',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_member_user_id`(`user_id` ASC) USING BTREE,
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE,
  INDEX `idx_phone`(`phone` ASC) USING BTREE,
...
-- ----------------------------
INSERT INTO `sys_member` VALUES (1, 7, '张三', NULL, '13900001001', '110101199001011001', 'MEMBER', 5, '2024-06-01 10:00:00', '2025-06-01 10:00:00', 1, 500.00, 2005.00, 1, 2200.00, '2024-06-01 10:00:00', '2026-02-18 14:00:18', 0);
INSERT INTO `sys_member` VALUES (2, 8, '李四', 0, '13900001002', '110101199002022002', 'MEMBER', 4, '2024-06-02 10:00:00', '2025-06-02 10:00:00', 1, 4520.00, 180.00, 0, 0.00, '2024-06-02 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (3, 9, '王五', 1, '13900001003', '110101199003033003', 'MEMBER', 5, '2024-06-03 10:00:00', '2025-06-03 10:00:00', 1, 3795.00, 605.00, 0, 1000.00, '2024-06-03 10:00:00', '2026-02-16 21:49:53', 0);
INSERT INTO `sys_member` VALUES (4, 10, '赵六', 0, '13900001004', '110101199004044004', 'MEMBER', 2, '2024-06-04 10:00:00', '2025-06-04 10:00:00', 1, 2150.00, 50.00, 0, 0.00, '2024-06-04 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (5, 11, '孙七', 1, '13900001005', '110101199005055005', 'MEMBER', 5, '2024-06-05 10:00:00', '2025-06-05 10:00:00', 1, 980.00, 1370.00, 0, 1350.00, '2024-06-05 10:00:00', '2026-02-09 13:33:48', 0);
INSERT INTO `sys_member` VALUES (6, 15, '周八', 1, '13900001006', '110101199006066006', 'MEMBER', 5, '2024-07-01 10:00:00', '2025-07-01 10:00:00', 1, 7200.00, 500.00, 0, 0.00, '2024-07-01 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (7, 16, '吴九', 0, '13900001007', '110101199007077007', 'MEMBER', 4, '2024-07-02 10:00:00', '2025-07-02 10:00:00', 1, 5800.00, 350.00, 0, 0.00, '2024-07-02 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (8, 17, '郑十', 1, '13900001008', '110101199008088008', 'MEMBER', 4, '2024-07-03 10:00:00', '2025-07-03 10:00:00', 1, 5200.00, 280.00, 0, 0.00, '2024-07-03 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (9, 18, '钱十一', NULL, '13900001009', '110101199009099009', 'MEMBER', 5, NULL, '2025-07-04 10:00:00', 1, NULL, 800.00, 0, 0.00, '2024-07-04 10:00:00', '2026-02-07 16:13:51', 0);
INSERT INTO `sys_member` VALUES (10, 19, '孙十二', 1, '13900001010', '110101199010101010', 'MEMBER', 3, '2024-07-05 10:00:00', '2025-07-05 10:00:00', 1, 3600.00, 100.00, 0, 0.00, '2024-07-05 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (11, 20, '李十三', 0, '13900001011', '110101199011111011', 'MEMBER', 2, '2024-07-06 10:00:00', '2025-07-06 10:00:00', 1, 2400.00, 80.00, 0, 0.00, '2024-07-06 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (12, 21, '王十四', 1, '13900001012', '110101199012121012', 'MEMBER', 2, '2024-07-07 10:00:00', '2025-07-07 10:00:00', 1, 2200.00, 60.00, 0, 0.00, '2024-07-07 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (13, 22, '张十五', 0, '13900001013', '110101199013131013', 'MEMBER', 1, '2024-07-08 10:00:00', '2025-07-08 10:00:00', 1, 1200.00, 30.00, 0, 0.00, '2024-07-08 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (14, 23, '刘十六', 1, '13900001014', '110101199014141014', 'MEMBER', 1, '2024-07-09 10:00:00', '2025-07-09 10:00:00', 1, 1000.00, 25.00, 0, 0.00, '2024-07-09 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (15, 24, '陈十七', 0, '13900001015', '110101199015151015', 'MEMBER', 5, '2024-07-10 10:00:00', '2025-07-10 10:00:00', 1, 6900.00, 350.00, 1, 0.00, '2024-07-10 10:00:00', '2026-02-18 14:09:15', 0);
INSERT INTO `sys_member` VALUES (16, 25, '杨十八', 1, '13900001016', '110101199016161016', 'MEMBER', 4, '2024-07-11 10:00:00', '2025-07-11 10:00:00', 1, 5400.00, 320.00, 0, 0.00, '2024-07-11 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (17, 26, '黄十九', 0, '13900001017', '110101199017171017', 'MEMBER', 3, '2024-07-12 10:00:00', '2025-07-12 10:00:00', 1, 4000.00, 200.00, 0, 0.00, '2024-07-12 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (18, 27, '林二十', 1, '13900001018', '110101199018181018', 'MEMBER', 2, '2024-07-13 10:00:00', '2025-07-13 10:00:00', 1, 2600.00, 90.00, 0, 0.00, '2024-07-13 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (19, 28, '徐二一', 0, '13900001019', '110101199019191019', 'MEMBER', 1, '2024-07-14 10:00:00', '2025-07-14 10:00:00', 1, 1400.00, 40.00, 0, 0.00, '2024-07-14 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (20, 29, '朱二二', 1, '13900001020', '110101199020202020', 'MEMBER', 5, '2024-08-01 10:00:00', '2025-08-01 10:00:00', 1, 7500.00, 600.00, 0, 0.00, '2024-08-01 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (21, 30, '马二三', 0, '13900001021', '110101199021212021', 'MEMBER', 4, '2024-08-02 10:00:00', '2025-08-02 10:00:00', 1, 6000.00, 400.00, 0, 0.00, '2024-08-02 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (22, 31, '胡二四', 1, '13900001022', '110101199022222022', 'MEMBER', 3, '2024-08-03 10:00:00', '2025-08-03 10:00:00', 1, 4200.00, 180.00, 0, 0.00, '2024-08-03 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (23, 32, '郭二五', 0, '13900001023', '110101199023232023', 'MEMBER', 2, '2024-08-04 10:00:00', '2025-08-04 10:00:00', 1, 2800.00, 100.00, 0, 0.00, '2024-08-04 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (24, 33, '何二六', 1, '13900001024', '110101199024242024', 'MEMBER', 1, '2024-08-05 10:00:00', '2025-08-05 10:00:00', 1, 1600.00, 50.00, 0, 0.00, '2024-08-05 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (25, 34, '高二七', 0, '13900001025', '110101199025252025', 'MEMBER', 5, '2024-08-06 10:00:00', '2025-08-06 10:00:00', 1, 8000.00, 700.00, 0, 0.00, '2024-08-06 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (26, 35, '罗二八', 1, '13900001026', '110101199026262026', 'MEMBER', 4, '2024-08-07 10:00:00', '2025-08-07 10:00:00', 1, 6200.00, 380.00, 0, 0.00, '2024-08-07 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (27, 36, '梁二九', 0, '13900001027', '110101199027272027', 'MEMBER', 3, '2024-08-08 10:00:00', '2025-08-08 10:00:00', 1, 4400.00, 220.00, 0, 0.00, '2024-08-08 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (28, 37, '宋三十', 1, '13900001028', '110101199028282028', 'MEMBER', 2, '2024-08-09 10:00:00', '2025-08-09 10:00:00', 1, 3000.00, 110.00, 0, 0.00, '2024-08-09 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (29, 38, '唐三一', 0, '13900001029', '110101199029292029', 'MEMBER', 1, '2024-08-10 10:00:00', '2025-08-10 10:00:00', 1, 1800.00, 60.00, 0, 0.00, '2024-08-10 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (30, 39, '许三二', 1, '13900001030', '110101199030303030', 'MEMBER', 5, '2024-09-01 10:00:00', '2025-09-01 10:00:00', 1, 8500.00, 800.00, 0, 0.00, '2024-09-01 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (31, 40, '韩三三', 0, '13900001031', '110101199031313031', 'MEMBER', 4, '2024-09-02 10:00:00', '2025-09-02 10:00:00', 1, 6600.00, 420.00, 0, 0.00, '2024-09-02 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (32, 41, '冯三四', 1, '13900001032', '110101199032323032', 'MEMBER', 3, '2024-09-03 10:00:00', '2025-09-03 10:00:00', 1, 4600.00, 240.00, 0, 0.00, '2024-09-03 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (33, 42, '于三五', 0, '13900001033', '110101199033333033', 'MEMBER', 2, '2024-09-04 10:00:00', '2025-09-04 10:00:00', 1, 3200.00, 120.00, 0, 0.00, '2024-09-04 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (34, 43, '董三六', 1, '13900001034', '110101199034343034', 'MEMBER', 1, '2024-09-05 10:00:00', '2025-09-05 10:00:00', 1, 2000.00, 70.00, 0, 0.00, '2024-09-05 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (35, 44, '萧三七', 0, '13900001035', '110101199035353035', 'MEMBER', 1, '2024-10-01 10:00:00', '2027-02-07 16:21:35', 1, 500.00, 200.00, 0, 0.00, '2024-10-01 10:00:00', '2026-02-07 16:21:34', 0);
INSERT INTO `sys_member` VALUES (36, 45, '程三八', 1, '13900001036', '110101199036363036', 'NORMAL', 1, '2024-10-02 10:00:00', NULL, 1, 300.00, 0.00, 0, 0.00, '2024-10-02 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (37, 46, '曹三九', 0, '13900001037', '110101199037373037', 'NORMAL', 1, '2024-10-03 10:00:00', NULL, 1, 200.00, 0.00, 0, 0.00, '2024-10-03 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (38, 47, '袁四十', 1, '13900001038', '110101199038383038', 'NORMAL', 1, '2024-10-04 10:00:00', NULL, 1, 150.00, 0.00, 0, 0.00, '2024-10-04 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (39, 48, '邓四一', NULL, '13900001039', '110101199039393039', 'MEMBER', 5, NULL, NULL, 1, NULL, 500.00, 0, 0.00, '2024-10-05 10:00:00', '2026-02-07 16:12:47', 0);
INSERT INTO `sys_member` VALUES (40, 49, '谢四二', 1, '13900001040', '110101199040404040', 'MEMBER', 3, '2023-06-01 10:00:00', '2024-06-01 10:00:00', 2, 3500.00, 0.00, 0, 0.00, '2023-06-01 10:00:00', NULL, 0);
INSERT INTO `sys_member` VALUES (41, 50, '叶四三', NULL, '13900001041', '110101199041414041', 'MEMBER', 2, NULL, '2024-07-01 10:00:00', 1, NULL, 0.00, 0, 0.00, '2023-07-01 10:00:00', '2026-02-07 16:13:00', 0);
INSERT INTO `sys_member` VALUES (42, 51, '吕四四', NULL, '13900001042', '110101199042424042', 'MEMBER', 4, NULL, '2025-05-01 10:00:00', 1, NULL, 0.00, 0, 0.00, '2024-05-01 10:00:00', '2026-02-07 16:13:04', 0);
INSERT INTO `sys_member` VALUES (43, 12, '测试用户001', 1, '13900009999', '110101199001011234', 'NORMAL', NULL, '2025-01-20 10:00:00', NULL, 1, 120.00, 100.00, 0, 100.00, '2025-01-20 10:00:00', '2026-02-07 16:33:11', 0);
INSERT INTO `sys_member` VALUES (44, 52, '演示用户A', NULL, '13800000000', '110101199001011234', 'NORMAL', NULL, '2026-02-06 16:47:32', NULL, 1, 0.00, 0.00, 0, 0.00, '2026-02-06 16:47:32', '2026-02-07 16:14:08', 1);
INSERT INTO `sys_member` VALUES (45, 53, '演示用户A', NULL, '13800000000', '110101199001011234', 'MEMBER', 5, NULL, '2027-02-07 16:15:42', 1, 3322.00, 10418.00, 12, 11515.00, '2026-02-07 16:14:32', '2026-02-22 15:31:22', 0);
INSERT INTO `sys_member` VALUES (54, 14, '佘建鹏', NULL, '', '', 'MEMBER', 5, '2026-02-22 15:23:48', '2027-02-22 15:36:58', 1, 0.00, 1200.00, 2, 1200.00, '2026-02-22 15:23:48', '2026-02-22 15:38:59', 0);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13800000000', '110101199001011234', '/api/uploads/avatars/b267beaeb9244675846ae04620f575b5.jpg', 'MALE', '你好，我是admin', 'PRESIDENT', NULL, 1, '2026-02-03 17:44:54', '2026-02-15 10:13:10', '2026-02-22 15:39:11');
...
INSERT INTO `sys_user` VALUES (13, '演示用户A', '$2a$10$YuBJgc8W4VYOMQKkFdBBROblGiKzqFq1CH7ylDWADoz7xLacJYdDq', '13800000000', '110101199001011234', NULL, NULL, NULL, 'VENUE_MANAGER', 6, 1, '2026-02-06 16:47:32', '2026-02-06 16:47:32', '2026-02-22 15:22:28');
INSERT INTO `sys_user` VALUES (14, '佘建鹏', '$2a$10$9RSrXJXP6ixxoK6pH/0aZua2wGoa84/tHMbw3L9UQvl.XikfVsLPi', '', '', NULL, NULL, NULL, 'USER', NULL, 1, '2026-02-22 15:23:48', '2026-02-22 15:36:58', '2026-02-22 15:40:42');
INSERT INTO `sys_user` VALUES (15, 'user006', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001006', '110101199006066006', NULL, 'MALE', NULL, 'USER', NULL, 1, '2024-07-01 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (16, 'user007', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001007', '110101199007077007', NULL, 'FEMALE', NULL, 'USER', NULL, 1, '2024-07-02 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (17, 'user008', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001008', '110101199008088008', NULL, 'MALE', NULL, 'USER', NULL, 1, '2024-07-03 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (18, 'user009', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001009', '110101199009099009', NULL, NULL, NULL, 'USER', NULL, 1, '2024-07-04 10:00:00', '2026-02-07 16:13:51', NULL);
INSERT INTO `sys_user` VALUES (19, 'user010', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001010', '110101199010101010', NULL, 'MALE', NULL, 'USER', NULL, 1, '2024-07-05 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (20, 'user011', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001011', '110101199011111011', NULL, 'FEMALE', NULL, 'USER', NULL, 1, '2024-07-06 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (21, 'user012', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001012', '110101199012121012', NULL, 'MALE', NULL, 'USER', NULL, 1, '2024-07-07 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (22, 'user013', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001013', '110101199013131013', NULL, 'FEMALE', NULL, 'USER', NULL, 1, '2024-07-08 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (23, 'user014', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001014', '110101199014141014', NULL, 'MALE', NULL, 'USER', NULL, 1, '2024-07-09 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (24, 'user015', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001015', '110101199015151015', NULL, 'FEMALE', NULL, 'USER', NULL, 1, '2024-07-10 10:00:00', '2026-02-18 14:09:15', NULL);
INSERT INTO `sys_user` VALUES (25, 'user016', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001016', '110101199016161016', NULL, 'MALE', NULL, 'USER', NULL, 1, '2024-07-11 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (26, 'user017', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001017', '110101199017171017', NULL, 'FEMALE', NULL, 'USER', NULL, 1, '2024-07-12 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (27, 'user018', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001018', '110101199018181018', NULL, 'MALE', NULL, 'USER', NULL, 1, '2024-07-13 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (28, 'user019', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001019', '110101199019191019', NULL, 'FEMALE', NULL, 'USER', NULL, 1, '2024-07-14 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (29, 'user020', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001020', '110101199020202020', NULL, 'MALE', NULL, 'USER', NULL, 1, '2024-08-01 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (30, 'user021', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001021', '110101199021212021', NULL, 'FEMALE', NULL, 'USER', NULL, 1, '2024-08-02 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (31, 'user022', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001022', '110101199022222022', NULL, 'MALE', NULL, 'USER', NULL, 1, '2024-08-03 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (32, 'user023', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001023', '110101199023232023', NULL, 'FEMALE', NULL, 'USER', NULL, 1, '2024-08-04 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (33, 'user024', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001024', '110101199024242024', NULL, 'MALE', NULL, 'USER', NULL, 1, '2024-08-05 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (34, 'user025', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001025', '110101199025252025', NULL, 'FEMALE', NULL, 'USER', NULL, 1, '2024-08-06 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (35, 'user026', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001026', '110101199026262026', NULL, 'MALE', NULL, 'USER', NULL, 1, '2024-08-07 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (36, 'user027', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001027', '110101199027272027', NULL, 'FEMALE', NULL, 'USER', NULL, 1, '2024-08-08 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (37, 'user028', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001028', '110101199028282028', NULL, 'MALE', NULL, 'USER', NULL, 1, '2024-08-09 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (38, 'user029', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001029', '110101199029292029', NULL, 'FEMALE', NULL, 'USER', NULL, 1, '2024-08-10 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (39, 'user030', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001030', '110101199030303030', NULL, 'MALE', NULL, 'USER', NULL, 1, '2024-09-01 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (40, 'user031', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001031', '110101199031313031', NULL, 'FEMALE', NULL, 'USER', NULL, 1, '2024-09-02 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (41, 'user032', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001032', '110101199032323032', NULL, 'MALE', NULL, 'USER', NULL, 1, '2024-09-03 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (42, 'user033', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001033', '110101199033333033', NULL, 'FEMALE', NULL, 'USER', NULL, 1, '2024-09-04 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (43, 'user034', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001034', '110101199034343034', NULL, 'MALE', NULL, 'USER', NULL, 1, '2024-09-05 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (44, 'user035', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001035', '110101199035353035', NULL, 'FEMALE', NULL, 'USER', NULL, 1, '2024-10-01 10:00:00', '2026-02-07 16:21:34', NULL);
INSERT INTO `sys_user` VALUES (45, 'user036', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001036', '110101199036363036', NULL, 'MALE', NULL, 'USER', NULL, 1, '2024-10-02 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (46, 'user037', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001037', '110101199037373037', NULL, 'FEMALE', NULL, 'USER', NULL, 1, '2024-10-03 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (47, 'user038', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001038', '110101199038383038', NULL, 'MALE', NULL, 'USER', NULL, 1, '2024-10-04 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (48, 'user039', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001039', '110101199039393039', NULL, NULL, NULL, 'USER', NULL, 1, '2024-10-05 10:00:00', '2026-02-07 16:12:47', NULL);
INSERT INTO `sys_user` VALUES (49, 'user040', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001040', '110101199040404040', NULL, 'MALE', NULL, 'USER', NULL, 1, '2023-06-01 10:00:00', NULL, NULL);
INSERT INTO `sys_user` VALUES (50, 'user041', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001041', '110101199041414041', NULL, NULL, NULL, 'USER', NULL, 1, '2023-07-01 10:00:00', '2026-02-07 16:13:00', NULL);
INSERT INTO `sys_user` VALUES (51, 'user042', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13900001042', '110101199042424042', NULL, NULL, NULL, 'USER', NULL, 1, '2024-05-01 10:00:00', '2026-02-07 16:13:04', NULL);
INSERT INTO `sys_user` VALUES (52, 'user044', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13800000000', '110101199001011234', NULL, NULL, NULL, 'USER', NULL, 0, '2026-02-06 16:47:32', '2026-02-07 16:14:08', NULL);
INSERT INTO `sys_user` VALUES (53, 'user045', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '13800000000', '110101199001011234', NULL, NULL, NULL, 'USER', NULL, 1, '2026-02-07 16:14:32', '2026-02-22 15:31:22', NULL);
...
INSERT INTO `sys_venue` VALUES (6, '演示羽毛球馆', '演示市演示路1号', '13800000000', '演示用户A', '06:30-21:30', '演示场馆简介', '/api/uploads/venues/6abe8db1db464fe7bd7c5e244dbdb3fe.jpg', NULL, NULL, 1, '2026-02-06 16:46:44', '2026-02-06 16:46:44');
...
-- ----------------------------
-- 初始化预约明细数据（依赖 sys_court，放在基础表之后执行）
-- ----------------------------
...
-- ----------------------------
-- 回填赛事报名快照字段（依赖 sys_member，放在基础表之后执行）
-- ----------------------------
UPDATE `biz_tournament_registration` tr
...
SET tr.`registrant_name` = m1.`member_name`,
    tr.`registrant_phone` = m1.`phone`,
    tr.`registrant_id_card` = m1.`id_card`,
    tr.`event_type_snapshot` = t.`event_type`,
    tr.`event_type_name_snapshot` = CASE t.`event_type`
      WHEN 'MS' THEN '男单'
      WHEN 'WS' THEN '女单'
      WHEN 'MD' THEN '男双'
      WHEN 'WD' THEN '女双'
      ...
      ELSE NULL
    END,
    tr.`partner_name_snapshot` = m2.`member_name`,
    tr.`partner_phone_snapshot` = m2.`phone`
WHERE tr.`del_flag` = 0;

ALTER TABLE `biz_booking`
  ADD CONSTRAINT `biz_booking_ibfk_1` FOREIGN KEY (`member_id`) REFERENCES `sys_member` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  ADD CONSTRAINT `biz_booking_ibfk_2` FOREIGN KEY (`court_id`) REFERENCES `sys_court` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT;

ALTER TABLE `biz_booking_court`
  ADD CONSTRAINT `biz_booking_court_ibfk_1` FOREIGN KEY (`booking_id`) REFERENCES `biz_booking` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  ADD CONSTRAINT `biz_booking_court_ibfk_2` FOREIGN KEY (`court_id`) REFERENCES `sys_court` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT;
...
ALTER TABLE `biz_course`
  ...
  ADD CONSTRAINT `biz_course_ibfk_2` FOREIGN KEY (`court_id`) REFERENCES `sys_court` (`id`) ON DELETE SET NULL ON UPDATE RESTRICT;

ALTER TABLE `biz_course_booking`
  ADD CONSTRAINT `biz_course_booking_ibfk_1` FOREIGN KEY (`member_id`) REFERENCES `sys_member` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  ADD CONSTRAINT `biz_course_booking_ibfk_2` FOREIGN KEY (`course_id`) REFERENCES `biz_course` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT;

ALTER TABLE `biz_equipment_rental`
  ADD CONSTRAINT `biz_equipment_rental_ibfk_1` FOREIGN KEY (`member_id`) REFERENCES `sys_member` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  ADD CONSTRAINT `biz_equipment_rental_ibfk_2` FOREIGN KEY (`equipment_id`) REFERENCES `sys_equipment` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  ADD CONSTRAINT `biz_equipment_rental_ibfk_3` FOREIGN KEY (`venue_id`) REFERENCES `sys_venue` (`id`) ON DELETE SET NULL ON UPDATE RESTRICT;

ALTER TABLE `biz_feedback`
  ADD CONSTRAINT `biz_feedback_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `sys_user` (`id`) ON DELETE SET NULL ON UPDATE RESTRICT;

ALTER TABLE `biz_finance`
  ADD CONSTRAINT `biz_finance_ibfk_1` FOREIGN KEY (`operator_id`) REFERENCES `sys_user` (`id`) ON DELETE SET NULL ON UPDATE RESTRICT,
...
ALTER TABLE `biz_member_consume_record`
  ADD CONSTRAINT `biz_member_consume_record_ibfk_1` FOREIGN KEY (`member_id`) REFERENCES `sys_member` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  ADD CONSTRAINT `biz_member_consume_record_ibfk_2` FOREIGN KEY (`venue_id`) REFERENCES `sys_venue` (`id`) ON DELETE SET NULL ON UPDATE RESTRICT;

ALTER TABLE `biz_recharge_record`
  ADD CONSTRAINT `biz_recharge_record_ibfk_1` FOREIGN KEY (`member_id`) REFERENCES `sys_member` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  ADD CONSTRAINT `biz_recharge_record_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `sys_user` (`id`) ON DELETE SET NULL ON UPDATE RESTRICT,
  ADD CONSTRAINT `biz_recharge_record_ibfk_3` FOREIGN KEY (`venue_id`) REFERENCES `sys_venue` (`id`) ON DELETE SET NULL ON UPDATE RESTRICT;

ALTER TABLE `biz_stringing_service`
  ADD CONSTRAINT `biz_stringing_service_ibfk_1` FOREIGN KEY (`member_id`) REFERENCES `sys_member` (`id`) ON DELETE SET NULL ON UPDATE RESTRICT,
  ADD CONSTRAINT `biz_stringing_service_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `sys_user` (`id`) ON DELETE SET NULL ON UPDATE RESTRICT,
  ADD CONSTRAINT `biz_stringing_service_ibfk_3` FOREIGN KEY (`venue_id`) REFERENCES `sys_venue` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  ADD CONSTRAINT `biz_stringing_service_ibfk_4` FOREIGN KEY (`string_id`) REFERENCES `sys_equipment` (`id`) ON DELETE SET NULL ON UPDATE RESTRICT;

ALTER TABLE `biz_tournament`
  ADD CONSTRAINT `biz_tournament_ibfk_1` FOREIGN KEY (`venue_id`) REFERENCES `sys_venue` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT;

ALTER TABLE `biz_tournament_registration`
  ADD CONSTRAINT `biz_tournament_registration_ibfk_1` FOREIGN KEY (`tournament_id`) REFERENCES `biz_tournament` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  ADD CONSTRAINT `biz_tournament_registration_ibfk_2` FOREIGN KEY (`member_id`) REFERENCES `sys_member` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  ADD CONSTRAINT `biz_tournament_registration_ibfk_3` FOREIGN KEY (`partner_id`) REFERENCES `sys_member` (`id`) ON DELETE SET NULL ON UPDATE RESTRICT;

ALTER TABLE `sys_coach`
  ADD CONSTRAINT `sys_coach_ibfk_1` FOREIGN KEY (`venue_id`) REFERENCES `sys_venue` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
...
ALTER TABLE `sys_court`
  ADD CONSTRAINT `sys_court_ibfk_1` FOREIGN KEY (`venue_id`) REFERENCES `sys_venue` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT;

ALTER TABLE `sys_equipment`
  ADD CONSTRAINT `sys_equipment_ibfk_1` FOREIGN KEY (`venue_id`) REFERENCES `sys_venue` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT;

ALTER TABLE `sys_equipment_image`
  ADD CONSTRAINT `sys_equipment_image_ibfk_1` FOREIGN KEY (`equipment_id`) REFERENCES `sys_equipment` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT;
...
ALTER TABLE `sys_user`
  ADD CONSTRAINT `fk_sys_user_venue` FOREIGN KEY (`venue_id`) REFERENCES `sys_venue` (`id`) ON DELETE SET NULL ON UPDATE RESTRICT;

ALTER TABLE `sys_user_setting`
  ADD CONSTRAINT `sys_user_setting_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `sys_user` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT;

ALTER TABLE `sys_venue_image`
  ADD CONSTRAINT `sys_venue_image_ibfk_1` FOREIGN KEY (`venue_id`) REFERENCES `sys_venue` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT;

ALTER TABLE `sys_venue_schedule`
  ADD CONSTRAINT `sys_venue_schedule_ibfk_1` FOREIGN KEY (`venue_id`) REFERENCES `sys_venue` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT;

ALTER TABLE `sys_venue_status_log`
  ADD CONSTRAINT `sys_venue_status_log_ibfk_1` FOREIGN KEY (`venue_id`) REFERENCES `sys_venue` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT;
